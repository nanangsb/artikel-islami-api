...
export async function GET(request: NextRequest) {
  try {
    const REMAJA_NEWS_RSS = "https://remajaislam.com/feed";
    ...
    let responseData = {
      messages: "Result of all articles in Remaja Islam",
      total: data.length,
      data,
    };
    ...
    if (searchParams) {
      ...
      responseData = {
        messages: `Result of all articles in Remaja Islam with title search: ${searchParams}`,
